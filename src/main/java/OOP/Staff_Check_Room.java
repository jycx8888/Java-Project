 ...
 * @author Justin Yong
 */
public class Staff_Check_Room extends javax.swing.JFrame {

    /**
     * Creates new form CheckRoom
     */
    public Staff_Check_Room() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Staff_Check_Room.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Staff_Check_Room().setVisible(true);
            }
        });
    }
